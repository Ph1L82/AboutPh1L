package cl.philipsoft.aboutph1l;
        ...
        sendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (msg.trim().length() > 0) {
                    ...
                    intent.putExtra(Intent.EXTRA_EMAIL, new String[]{"eduardo.rodriguez.bahamonde@gmail.com"});
                    intent.putExtra(Intent.EXTRA_SUBJECT, "AboutPh1L_CONTACTO");
